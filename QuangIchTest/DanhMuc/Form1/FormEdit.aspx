<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormEdit.aspx.cs" Inherits="QuangIchTest.DanhMuc.Form1.FormEdit" %>
            ...
            <div class="container editForm-subject">
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-8">
                            <asp:TextBox ID="txtMa" disabled="true" runat="server" CssClass="form-control"></asp:TextBox>
                            <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbMa"
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-8">
                            <asp:TextBox ID="txtTen" disabled="true" runat="server" CssClass="form-control"></asp:TextBox>
                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="tbMa"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-8">
                            <telerik:RadComboBox ID="RadComboBox1" runat="server" DataSourceID="objKhoi" DataTextField="TEN" DataValueField="MA" Width="100%"
                                EmptyMessage="Chọn cấp học" AllowCustomText="true" Filter="Contains" OnSelectedIndexChanged="load">
                            </telerik:RadComboBox>
